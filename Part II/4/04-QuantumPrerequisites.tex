...
\begin{lemma}[Support under unitary conjugation]\label{lem:supp-unitary}
...
\begin{lemma}[Support of sums]\label{lem:supp-sum}
...
In particular, properties such as $J(\mathcal{E})\succeq 0$ and inequalities like
...
If $\mathcal{E}$ is a positive superoperator, then $J(\mathcal{E})\succeq 0$.
...
guarantees existence of an operator limit $J=\lim_n J(E_n)\succeq 0$; the corresponding limit map
...
Let $\rho \succeq 0$ and let $P,Q$ be projections.
